...
class _HomePageState extends State<HomePage> 
{
  ...
  String name = null;
  String email = null;
  var blogArr =['Tech','Non-Tech','Interview','Intership','Food','Travel','Political','Business'];
  var blogExtention=['Blogs','Blogs','Exps','Exps','Blogs','Blogs','Blogs','Blogs'];
  var flushbar;
  void show(String s1) 
  {
      flushbar = Flushbar(
